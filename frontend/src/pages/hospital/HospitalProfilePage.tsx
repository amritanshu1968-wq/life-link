...
export const HospitalProfilePage: React.FC = () => {
  ...
  if (loading) return <div className="text-center py-8 text-xs text-gray-500">Loading hospital profile...</div>;

  return (
    <div className="max-w-2xl space-y-6">
      <div>
        <h1 className="text-xl font-bold text-gray-900">Hospital Facility Profile</h1>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-5 shadow-sm space-y-4 text-xs">
        <div className="flex items-center space-x-3 pb-3 border-b border-gray-100">
          ...
          <div>
            <h3 className="font-bold text-gray-900 text-sm">{profile?.hospitalName}</h3>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <VerificationBadge status={profile?.verificationStatus} entityName="FACILITY" />
          </div>
